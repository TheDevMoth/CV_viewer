...
namespace WinFormsApp1
{
    internal static class Program
    {
        ...
        static void Main()
        {
            ...
            Applicant[] applicants = GetApplicants(files);
        ...
        static Applicant[] GetApplicants(string[] files)
        {
        ...
        static dynamic? ReadJson(string file)
        {
            // read the json file
        ...
        static Location? ExtractLocation(dynamic loc)
        {
            if (loc == null)
                return null;
            
            return new Location((string) loc.Country, (string?) loc.CountryCode, (string?) loc.State,
                (string?) loc.City, (string?) loc.Street, (string?) loc.StreetNumber, (string?) 
                loc.ApartmentNumber, (string?) loc.PostalCode);
        }

        static DateTime? ExtractDate(dynamic date)
        {
            if (date == null)
                return null;
        ...
        static TimePeriod? ExtractTimePeriod(dynamic period)
        {
            if (period == null)
                return null;
        ...
        static Education[] ExtractEducation(dynamic edu)
        {
        ...
        static Skill[] ExtractSkills(dynamic skills)
        {
        ...
        static Source[] ExtractSources(dynamic sources)
        {
        ...
        static WorkExperience[] ExtractWorkExperience(dynamic workExperience)
        {
        ...
        static JobClassification? ExtractJobClassification(dynamic classification)
        {
